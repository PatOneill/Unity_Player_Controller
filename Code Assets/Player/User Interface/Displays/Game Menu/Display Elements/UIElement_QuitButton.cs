...
public class UIElement_QuitButton : IElementSubmissionTypeSetup {
    ...
    public UIElement_QuitButton(GameObject display, IGetReceiverFunctionality inputReceivers, UI_DisplayTransitions transitions) {
        _ButtonAnimator = display.transform.Find("Quit Button").gameObject.GetComponent<Animator>();
