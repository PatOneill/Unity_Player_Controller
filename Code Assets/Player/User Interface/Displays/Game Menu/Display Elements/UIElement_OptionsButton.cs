...
public class UIElement_OptionsButton : IElementSubmissionTypeSetup {
    ...
    public UIElement_OptionsButton(GameObject display, IGetReceiverFunctionality inputReceivers, UI_DisplayTransitions transitions) {
        _ButtonAnimator = display.transform.Find("Options Button").gameObject.GetComponent<Animator>();
    ...
    public void SetupSubmissionTypes() {
        ...
        */
        _SubmissionReceiver.SetUIElementSubmissionTypeOneStrategy = new Strategy_ElementSubmissionTypeOneDisplayTransition(_ButtonAnimator, _PossibleWindowTransitions.TransitionToOptionsMenu);
    }
