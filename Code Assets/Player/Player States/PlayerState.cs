...
public class PlayerState : IStateProxyInput, IStateProxy, IState {
    ...
    private readonly GameMenuProxy _ProxyGameMenu;
    private readonly ItemInteractionProxy _ProxyItemInteraction;
    #endregion
    ...
    public IStateProxyOnOff ProxyItemInteraction() { return _ProxyItemInteraction; }
    public IStateProxyOnOff ProxyGameMenu() { return _ProxyGameMenu; }
    ...
    public PlayerState(IEventManager playerEvent, PhysicsItemPickup itemDetection) {
        ...
        _ProxyItemInteraction = new ItemInteractionProxy(this, itemDetection);
        _ProxyGameMenu = new GameMenuProxy(this);
