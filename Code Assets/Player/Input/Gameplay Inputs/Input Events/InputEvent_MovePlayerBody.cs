...
public class InputEvent_MovePlayerBody : IInputAnalogStart, IInputAnalogPerfom, IInputAnalogCancel {
    private IAnalogInputEventObservable _ObservableInputEvent;

    public InputEvent_MovePlayerBody(IAnalogInputEventObservable observableInputEvent) {
        _ObservableInputEvent = observableInputEvent;
    }

    public void AnalogInputEventStart(Vector2 value) {
        /*
         * @Desc: Captuers the inital change in the analog stick assigned to the input event MovePlayerbody and notifies all watchers about the change
    ...
    public void AnalogInputEventPerform(Vector2 value) {
        /*
         * @Desc: Captuers all additional changes in the analog stick assigned to the input event MovePlayerbody and notifies all watchers about the change
         * @Param: Vector2 value - This parameter represents the current position of the analog stick on the user's controller.
    ...
    public void AnalogInputEventCancel() {
        /*
         * @Desc: Notifies all watchers that the analog stick assigned to the input event MovePlayerbody has returned to its resting position
        */
